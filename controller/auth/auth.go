...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	var user user.User
    err = database.DB.QueryRow("SELECT id, username, password,email FROM users WHERE username= (?)", creds.Username).Scan(&user.UserId, &user.Username, &user.Password, &user.Email)
    if err != nil {
